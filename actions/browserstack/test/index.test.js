...
describe('Action Tests', () => {
    ...
    context('parse and validate input', () => {
        it('should read values from input and validate them for Android', () => {
            setupAndroid();
        ...
        it('should give error message in case iosAppFilePath specified does not exist', () => {
            setupIOS();
            stubbedExists.withArgs("some/random/app/path.ipa").returns(false);
            expect(() => new ActionInput()).to.throw("App specified in iosAppFilePath doesn't exist");
        });

        it('should give error message in case iosTestFilePath specified does not exist', () => {
            setupIOS();
            stubbedExists.withArgs("some/random/test/path.zip").returns(false);
            expect(() => new ActionInput()).to.throw("App specified in iosTestFilePath doesn't exist");
        });
    });
});